...
final class PaywallFunnelTests: XCTestCase {
    ...
    func testCountsPitchesPerSurfaceAndInTotal() {
        ConversionDiagnostics.recordPitchView(impressionID: "cribbage_onboarding_trial")
        ConversionDiagnostics.recordPitchView(impressionID: "cribbage_onboarding_trial")
        ConversionDiagnostics.recordPitchView(impressionID: "cribbage_paywall_sheet")
    ...
    func testAttributeKeysStayInsideRevenueCatsLimit() {
        ...
        ConversionDiagnostics.recordPitchView(impressionID: "cribbage_\(long)")
