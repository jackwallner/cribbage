...
struct HomeView: View {
    ...
    @StateObject private var minuteStore = CribbageMinuteStore.shared
    ...
    @AppStorage("cribbage.hasReadPrimer") private var hasReadPrimer = false
    ...
    @AppStorage("cribbage.recommendedRoomHint") private var recommendedRoomHint = ""
    ...
    var body: some View {
        NavigationStack(path: $path) {
            ...
            .sheet(isPresented: $showPaywall) { PaywallView(source: "cribbage_home_sheet") }
...
extension DrillKind {
    var symbol: String {
        ...
        case .discard: return "arrow.left.arrow.right"
        }
    }
