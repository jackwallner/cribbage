    ...
    private var tourPages: [TourPage] {
        [
            TourPage(
                ...
                body: "Home is the lobby. Each room holds its own drills: meet the deck, read the score, choose a discard, and peg to 31. All four beginner rooms are free, forever.",
            ...
            subscriptions.isPro
                ...
                body: "Your trial already includes Endless Practice, the timed challenge, the extra sets in every room, and the Master Tables: advanced discards, defense, and expert counting.",
