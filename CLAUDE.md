...
|---|---|---|
| `.claude/rules/game-night.md` | Game-night rhythm (1.2): Cribbage Minute, the daily discard question, deterministic dealing, game night prep | `CribbageMinute*`, `GameNightPrepView`, `HandGenerator`, `SessionBuilder` |
