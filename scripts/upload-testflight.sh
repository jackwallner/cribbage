...
#
# Usage:
#   ./scripts/upload-testflight.sh [path/to/CribbageTrainer.xcarchive]
#
# Default archive: ./build/CribbageTrainer.xcarchive

set -euo pipefail
ROOT="$(cd "$(dirname "$0")/.." && pwd)"
ARCHIVE="${1:-$ROOT/build/CribbageTrainer.xcarchive}"
