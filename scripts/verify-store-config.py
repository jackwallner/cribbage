...
Build 21 was rejected because RevenueCat served the app an offering with zero
packages: the products existed only on the Test Store app, so an App Store
build had nothing to purchase and the trial CTA threw productsUnavailable.
...
PUBLIC_KEY = "appl_OgAKVcKNWSTOrcdpcKwBzNzUint"
