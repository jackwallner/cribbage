...
warm cream + jade frame matching CribbageTrainer/Utilities/Theme.swift (serif
...
# MARK: - Theme (mirrors CribbageTrainer/Utilities/Theme.swift light-mode values)
...
WATERMARK_GLYPH = "♣"  # same glyph CribbageCardFace uses
...
SHOTS = [
    ...
    Shot(
        ...
        eyebrow="THE DISCARD ROOM",
        headline="Make the call, learn the why",
        accent=GOLD,
    ),
    Shot(
        raw="04-pegging.png",
        out="04_pegging_room.png",
        eyebrow="THE PEGGING ROOM",
        headline="Find the right play on the count",
        accent=PLUM,
    ),
    Shot(
        raw="05-home.png",
...
def draw_background(img: Image.Image, accent: tuple) -> None:
    ...
    headline zone, plus the cribbage-card watermark glyph bottom-right."""
