...
/// On-device record of how someone met Cribbity Plus before they bought it: which
...
enum ConversionDiagnostics {
    private static let logger = Logger(subsystem: "com.jackwallner.cribbage", category: "Conversion")
    ...
    private static let impressionPrefix = "cribbage_"
